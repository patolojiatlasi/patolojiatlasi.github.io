---
description: |
    Patoloji Atlası Memorial Patoloji Hekim ve Teknikerleri yanısıra diğer kurumlardan kolleksiyonlarını paylaşan patologların katkılarıyla hazırlanmaktadır.
    TemplateEN, TemplateTR, patoloji, atlas, pathology, whole slide image templateTR
date: last-modified
categories: [yazarlar, katkıda bulunanlar, authors, editors, contributors]
page-layout: full
...
# Authors and Contributors {#sec-authors-contributors .unnumbered}
```
