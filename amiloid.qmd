...
if (!file.exists("./screenshots/congoredvideo_screenshot.jpg")) {

url <- "https://img.youtube.com/vi/U9glkfQLTm4/maxresdefault.jpg"
download.file(url, destfile = "./screenshots/congoredvideo_screenshot.jpg", mode = "wb")
}
```
...
[![Video İçin Tıklayın](./screenshots/congored_video_screenshot.png){width="25%"}](https://www.youtube.com/watch?v=U9glkfQLTm4) [Video İçin Tıklayın](https://www.youtube.com/watch?v=U9glkfQLTm4)
