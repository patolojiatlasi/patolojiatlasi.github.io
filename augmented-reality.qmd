...
description: |
    ...
    whole slide image
date: last-modified
categories: [Artırılmış Gerçeklik, Augmented Reality, Patoloji Atlası, Pathology Atlas, Whole Slide Image]
page-layout: full
...
# Artırılmış Gerçeklik {#sec-artirilmis-gerceklik}
```

```{asis, echo = (language == "EN")}
# Augmented Reality {#sec-augmented-reality}
```
